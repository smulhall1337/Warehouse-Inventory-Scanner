...
public class ScanWindow {
	...
	private int itemNumber, itemWeight = 1, itemStock = 0, itemRestock = 0, itemAdd = 0;
	private String itemName, itemPrice = "0.00", input = ""; 
	private boolean found, isM;
	public List itemTypeList = new ArrayList<String>();
